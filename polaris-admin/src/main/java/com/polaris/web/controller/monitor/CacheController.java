...
import com.polaris.system.domain.SysCache;
...
public class CacheController
{
    ...
    @Operation(summary = "获取 Redis 缓存监控信息")
    @GetMapping()
