package com.polaris.common.utils.file;
...
import com.polaris.common.exception.file.FileNameLengthLimitExceededException;
import com.polaris.common.exception.file.FileSizeLimitExceededException;
import com.polaris.common.exception.file.InvalidExtensionException;
...
import com.polaris.common.utils.uuid.Seq;
...
public class FileUploadUtils
{
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = PolarisConfig.getProfile();
    ...
    {
        int dirLastIndex = PolarisConfig.getProfile().length() + 1;
