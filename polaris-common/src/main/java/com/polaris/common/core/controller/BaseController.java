package com.polaris.common.core.controller;
...
import com.polaris.common.core.page.PageDomain;
import com.polaris.common.core.page.TableDataInfo;
import com.polaris.common.core.page.TableSupport;
import com.polaris.common.utils.DateUtils;
import com.polaris.common.utils.PageUtils;
import com.polaris.common.utils.SecurityUtils;
import com.polaris.common.utils.StringUtils;
import com.polaris.common.utils.sql.SqlUtil;
...
public class BaseController {
     ...
     * @return
     */
    protected Page<?> getDataPage(List<?> list) {
        return Page.of(PageInfo.of(list));
    }
    ...
    public ResultData ok(Object data) {
    ...
    protected ResultData toAjaxResult(int rows) {
        return rows > 0 ? ResultData.ok() : ResultData.fail();
    }

    protected ResultData toAjaxResult(boolean result) {
        return result ? ResultData.ok() : ResultData.fail();
    }
}
