<template>
  <div id="tags-view-container" :class="{ 'tags-view-container--chrome': tagsViewStyle === 'chrome' }" :style="chromeVars" class="tags-view-container">
    <!-- 左切换箭头 -->
    <span :class="{ disabled: !canScrollLeft }" class="tags-nav-btn tags-nav-btn--left" @click="scrollLeft">
    ...
    <!-- 右切换箭头 -->
    <span :class="{ disabled: !canScrollRight }" class="tags-nav-btn tags-nav-btn--right" @click="scrollRight">
      <i class="el-icon-arrow-right" />
    </span>

    <!-- 下拉操作菜单 -->
    <el-dropdown class="tags-action-dropdown" placement="bottom-end" trigger="click" @command="handleDropdownCommand">
      ...
      <el-dropdown-menu slot="dropdown" class="tags-dropdown-menu">
        ...
        <el-dropdown-item :disabled="isFirstView()" command="closeLeft" icon="el-icon-back">关闭左侧</el-dropdown-item>
        <el-dropdown-item :disabled="isLastView()" command="closeRight" icon="el-icon-right">关闭右侧</el-dropdown-item>
