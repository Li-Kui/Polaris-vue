<template>
  <div>
    <el-popover ref="noticePopover" :value="noticeVisible" placement="bottom-end" popper-class="notice-popover" trigger="manual" width="320">
      ...
      <div v-else>
        <div v-for="item in noticeList" :key="item.noticeId" :class="{ 'is-read': item.isRead }" class="notice-item" @click="previewNotice(item)">
          <el-tag :type="item.noticeType === '1' ? 'warning' : 'success'" class="notice-tag" size="mini">
