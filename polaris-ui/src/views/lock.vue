<template>
  <div class="lock-container">
    ...
    <div class="lock-card">
      ...
      <div :class="{ shake: isShaking }" class="input-wrap">
        <input ref="passwordInput" v-model="password" autocomplete="off" class="lock-input" placeholder="请输入登录密码" type="password" @keydown.enter="handleUnlock" />
        <button :disabled="loading" class="unlock-btn" @click="handleUnlock">
