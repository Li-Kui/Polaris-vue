<template>
  <el-dialog :title="type === 'log' ? '调度日志详细' : '任务详细'" :visible.sync="visible" append-to-body width="780px" @close="$emit('update:visible', false)">
          ...
          <el-row class="detail-row">
            ...
            <el-col :span="12">
              <div class="detail-item">
                ...
                <el-tag v-if="form.status == 0" size="small" type="success">正常</el-tag>
          ...
          <el-row class="detail-row">
            ...
            <el-col :span="12">
              <div class="detail-item">
                <span class="detail-label">执行状态</span>
                <el-tag v-if="form.status == 0" size="small" type="success">正常</el-tag>
                <el-tag v-else size="small" type="info">暂停</el-tag>
              </div>
            </el-col>
          </el-row>
        </div>
          ...
          <el-row class="detail-row">
            <el-col :span="12">
              <div class="detail-item">
                ...
                <el-tag v-if="form.misfirePolicy == 0" size="small" type="info">默认策略</el-tag>
                <el-tag v-else-if="form.misfirePolicy == 1" size="small" type="warning">立即执行</el-tag>
                <el-tag v-else-if="form.misfirePolicy == 2" size="small" type="primary">执行一次</el-tag>
                <el-tag v-else-if="form.misfirePolicy == 3" size="small" type="danger">放弃执行</el-tag>
              </div>
            </el-col>
            <el-col :span="12">
              <div class="detail-item">
                <span class="detail-label">并发执行</span>
                <el-tag v-if="form.concurrent == 0" size="small" type="success">允许</el-tag>
