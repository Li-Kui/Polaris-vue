<template>
  <el-dialog :visible.sync="visible" append-to-body title="操作日志详细" width="780px" @close="$emit('update:visible', false)">
    <div class="detail-wrap">
        ...
        <el-row class="detail-row">
          ...
          <el-col :span="12">
            <div class="detail-item">
              ...
              <el-tag v-if="form.status === 0" size="small" type="success"><i class="el-icon-check"></i> 正常</el-tag>
              <el-tag v-else size="small" type="danger"><i class="el-icon-close"></i> 异常</el-tag>
            </div>
          </el-col>
        </el-row>
      </div>
        ...
        <div class="code-body">
          <div class="code-wrap">
            <div class="code-action">
              <el-button icon="el-icon-copy-document" size="mini" @click="copyText(form.operParam)">复制</el-button>
            </div>
      ...
      <div class="detail-card">
        ...
        <div class="code-body">
          <div class="code-wrap">
            <div class="code-action">
              <el-button icon="el-icon-copy-document" size="mini" @click="copyText(form.jsonResult)">复制</el-button>
            </div>
