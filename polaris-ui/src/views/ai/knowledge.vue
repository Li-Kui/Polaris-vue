  ...
  <div class="knowledge-wrapper">
    ...
    <main class="kb-main">
      <div v-if="!currentKbId" class="select-prompt">
        ...
        <i class="el-icon-collection select-prompt-icon"></i>
      ...
      <div v-else class="kb-content">
        ...
        <header class="kb-content-header">
          <div class="kb-detail-title">
            ...
            <el-tag class="kb-tag" size="small" type="info">向量知识库</el-tag>
          </div>
        ...
        <section class="kb-upload-section">
          <el-upload
            ...
            multiple
          >
            <i class="el-icon-upload kb-upload-icon"></i>
        ...
        <section class="kb-docs-section">
          ...
          >
            <el-table-column label="文档名称" min-width="220" prop="name" show-overflow-tooltip>
              <template slot-scope="scope">
                <div class="doc-name-cell">
                  <i :class="getFileIcon(scope.row.name)" class="doc-type-icon"></i>
            ...
            <el-table-column label="解析状态" prop="status" width="140">
              <template slot-scope="scope">
                <el-tag :type="getStatusTag(scope.row.status)" class="status-tag" size="medium">
                  <i v-if="scope.row.status === '1'" class="el-icon-loading status-spin"></i>
    ...
    >
      ...
      <div slot="footer" class="dialog-footer">
        <el-button size="small" @click="openDialog = false">取 消</el-button>
        <el-button class="btn-gradient" size="small" type="primary" @click="submitForm">确 定</el-button>
      </div>
    </el-dialog>
  </div>
</template>
...
export default {
  ...
  data() {
    return {
      ...
      // 上传配置
      uploadUrl: process.env.VUE_APP_BASE_API + "/ai/knowledge/document/upload",
      uploadHeaders: {
  ...
  methods: {
    ...
    getFileIcon(filename) {
      ...
      switch (ext) {
        case "pdf": return "el-icon-document-checked";
        case "xlsx":
        case "xls": return "el-icon-data-analysis";
        case "docx":
        case "doc": return "el-icon-document-copy";
        case "txt":
        case "md": return "el-icon-tickets";
...
::v-deep .el-upload-dragger:hover .kb-upload-icon {
  color: #3b82f6;
}
...
::v-deep .kb-dialog .el-dialog__header {
  background: #f8fafc;
  padding: 20px;
  border-bottom: 1px solid #e2e8f0;
}
::v-deep .kb-dialog .el-dialog__title {
  font-weight: 700;
  color: #1e293b;
}
::v-deep .kb-dialog .el-dialog__body {
  padding: 24px 30px;
}
</style>
