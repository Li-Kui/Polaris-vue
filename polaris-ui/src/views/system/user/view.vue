<template>
  <el-drawer :before-close="handleClose" :visible.sync="visible" append-to-body custom-class="detail-drawer" direction="rtl" size="68%" title="用户信息详情">
        ...
        <el-col :span="12">
          <div class="info-item">
            ...
            <span class="info-value plaintext">
              <el-tag :type="info.status === '0' ? 'success' : 'danger'" size="small">{{ info.status === '0' ? '正常' : '停用' }}</el-tag>
            </span>
          </div>
        </el-col>
      </el-row>
