-- ----------------------------------------------------------------------------
-- Polaris AI 基础能力模块完整数据库建表与初始化脚本
-- ----------------------------------------------------------------------------
...
CREATE TABLE `ai_model_config` (
  ...
  `tenant_id` bigint(20) DEFAULT NULL COMMENT '所属租户标识，管理端共享资源为空',
  ...
  PRIMARY KEY (`id`),
  KEY `idx_ai_model_workflow_resource` (`tenant_id`, `del_flag`, `status`, `model_type`)
...
CREATE TABLE `ai_knowledge_base` (
  ...
  `remark` varchar(500) DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`),
  KEY `idx_ai_knowledge_workflow_resource` (`tenant_id`, `del_flag`)
...
CREATE TABLE `ai_conversation` (
  ...
  `tenant_id` bigint(20) DEFAULT NULL COMMENT '所属租户标识',
...
CREATE TABLE `ai_agent` (
  ...
  KEY `idx_ai_agent_workflow_resource` (`tenant_id`, `del_flag`, `status`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='AI智能体定义表';

-- ----------------------------
-- 7. Table structure for ai_image_task (AI图像生成任务表)
-- ----------------------------
...
-- ----------------------------
-- 8. Table structure for ai_report (AI分析报告归档表)
-- ----------------------------
...
-- ----------------------------
-- 9. Table structure for ai_moderation_* (敏感内容安全风控表)
-- ----------------------------
