    ...
    <div v-if="viewMode === 'list'">
      ...
      <div class="filter-container">
        <el-form :model="queryParams" ref="queryForm" :inline="true" class="demo-form-inline">
          ...
          <el-form-item>
            ...
            <el-button class="btn-primary-glow" icon="Plus" type="primary" @click="handleAdd">新增智能体</el-button>
          </el-form-item>
        </el-form>
      </div>
      ...
      <div v-loading="loading" class="card-list-container">
        <div v-if="agentList.length === 0" class="empty-state">
          ...
          <p style="color: var(--el-text-color-primary) !important; font-weight: 600;">暂无智能体配置，点击上方“新增智能体”按钮开始配置您的 AI 智能体吧！</p>
        </div>
            ...
            <div :class="['agent-card', { 'is-disabled': item.status === '0' }]">
              ...
              <div class="card-body">
                <div class="param-row" style="margin-bottom: 12px;">
                  <span class="param-label"><el-icon><cpu /></el-icon> 选用底座</span>
                  <el-tag size="small" effect="plain" type="primary">{{ getModelLabel(item.modelConfigId, item.modelName) }}</el-tag>
                </div>

                <div class="param-row" style="margin-bottom: 12px;">
                  <span class="param-label"><el-icon><odometer /></el-icon> 随机温度</span>
                ...
                <div class="tools-section" style="margin-bottom: 14px;">
                  <span class="param-label" style="margin-bottom: 6px;"><el-icon><folder-opened /></el-icon> 绑定系统工具</span>
                  ...
                  <div v-else class="tool-pills-list">
                    ...
                    >
                      <el-icon><link-icon /></el-icon> {{ tool }}
                    </span>
                  </div>
                </div>
              ...
              <div class="card-footer">
                ...
                <div class="action-buttons">
                  <el-button class="footer-action-btn edit" icon="Edit" link size="small" @click="handleUpdate(item)">编辑</el-button>
    ...
    <div v-else class="agent-workbench-container">
      ...
      <div class="workbench-header">
        ...
        <div class="header-right">
          ...
          <el-button type="primary" size="small" class="btn-primary-glow" icon="CircleCheck" @click="submitForm">保存智能体</el-button>
        </div>
      </div>
...
.textarea-code-style :deep(.el-textarea__inner:focus) {
  border-color: var(--el-input-focus-border-color, var(--el-color-primary)) !important;
  box-shadow: 0 0 0 3px var(--el-color-primary-light-8, rgba(64, 158, 255, 0.15)) !important;
}
