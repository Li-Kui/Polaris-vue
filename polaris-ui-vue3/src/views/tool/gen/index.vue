  ...
  <div class="app-container no-sidebar-manage-wrap">
    <div class="content-inner">
      ...
      <div class="polaris-table-card">
        ...
        <el-table ref="genRef" v-loading="loading" :data="tableList" @selection-change="handleSelectionChange" :default-sort="defaultSort" @sort-change="handleSortChange" class="polaris-el-table">
    ...
    <!-- 预览界面 -->
    <el-dialog :title="preview.title" v-model="preview.open" width="80%" top="5vh" append-to-body class="polaris-glass-dialog scrollbar">
